...
class ProductPage:
    ...
    def __init__(self, page: Page):
        ...
        # ===== Locators =====
        self.txt_quantity    = page.locator('#input-quantity')                    # ← fixed (was input[name="quantity"])
    ...
    def get_confirmation_message(self):
        """Return the success confirmation message element."""
        try:
            return self.cnf_msg
        except Exception as e:
    ...
    def click_view_cart(self) -> ShoppingCartPage:
        """Click the 'View Cart' link and return a ShoppingCartPage instance."""
        try:
