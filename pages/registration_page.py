...
class RegistrationPage:
    ...
    def set_privacy_policy(self):
        ...
        self.chk_policy.check(force=True)  # force=True handles hidden/styled checkboxes

    def click_continue(self):
        """Click the Continue button and wait for page to load."""
        self.btn_continue.click()
        self.page.wait_for_load_state("domcontentloaded")  # more reliable than networkidle

    def get_confirmation_msg(self):
        """Wait for and return the confirmation message locator."""
        self.msg_confirmation.wait_for(state="visible", timeout=10000)  # explicit wait
