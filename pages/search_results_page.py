...
class SearchResultsPage:
    ...
    def get_search_results_heading(self):
        return self.page.locator("#content h1")

    def get_product_by_name(self, product_name: str):
        return self.page.locator(f".product-thumb h4 a:has-text('{product_name}')").first

    def select_product(self, product_name: str) -> ProductPage:
        """Click on the product by name and return a ProductPage instance."""
        self.page.locator(f".product-thumb h4 a:has-text('{product_name}')").first.click()
